...
USE BODEGUITA;
 -- CREATE USER 'user_bodeguita'@'%' IDENTIFIED BY 'Bodeguita_password123';
 -- GRANT ALL PRIVILEGES ON *.* TO 'user_bodeguita'@'%' WITH GRANT OPTION;
...
UNIQUE (CEDULA)
 ...
 ALTER TABLE TIPO_PRODUCTO CHANGE COD_TIPO COD_TIPO INT NOT NULL;
 ...
 ALTER TABLE PRODUCTOS ADD CONSTRAINT TIPO_PRODUCTOS FOREIGN KEY (COD_PRODUCTO) REFERENCES TIPO_PRODUCTO (COD_TIPO);
 ...
 CANTIDAD INT NOT NULL,
 PRIMARY KEY (ID),
 CONSTRAINT SALIDA_STOCK FOREIGN KEY (COD_PRODUCTO) REFERENCES STOCK_PRODUCTOS (COD_PRODUCTO)
 )ENGINE = InnoDB;
 ...
 ALTER TABLE PEDIDOS ADD INDEX (COD_PEDIDO);
